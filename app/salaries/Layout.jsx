...
const SidebarContent = () => {
  ...
  const navItems = [
    ...
    { href: "/employees/salary", icon: DollarSignIcon, label: "Employés journaliers" },
    { href: "/employees/meter", icon: GaugeIcon, label: "Employés par Mètre" },
    { href: "/clients", icon: UsersIcon, label: "Gestion Clients" },
    { href: "/devis", icon: ClipboardListIcon, label: "Devis" },
    { href: "/paiements", icon: WalletIcon, label: "Paiements" },
    { href: "/salaries", icon: WalletIcon, label: "Salaire_journalieraire" },
  ];
